...
Features included:
- A Charlson Comorbidity Index (CCI) calculator extracts baseline chronic 
  illness burden directly from the diagnoses_icd table. The score is appended to 
...
def main():
    ...
    # Read explicitly named file from Script 02
