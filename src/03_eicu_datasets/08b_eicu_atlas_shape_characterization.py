...
def run_shape_atlas_characterization():
    ...
    # Inputs - EXPLICITLY LOADING THE 'SHAPE' MATRIX
    dist_matrix_file = OUT_FEATS / "eicu_dtw_shape_pairwise_distance_matrix.npy"
    stay_id_file = OUT_FEATS / "eicu_shape_atlas_stay_ids.npy"
