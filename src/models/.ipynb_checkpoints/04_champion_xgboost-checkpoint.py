...
Phase 4: Train the Final Champion Model
...
OUT_MODELS = BASE_DIR / "outputs" / "champion" / "models"
OUT_PREDS = BASE_DIR / "outputs" / "champion" / "predictions"
OUT_METRICS = BASE_DIR / "outputs" / "champion" / "metrics"
OUT_FEATS = BASE_DIR / "outputs" / "champion" / "feature_names"
...
def main():
    ...
    with open(OUT_FEATS / "champion_features.json", "w") as f: 
    ...
    # Save Model
    joblib.dump(champion_xgb, OUT_MODELS / "champion_xgboost.joblib")
    ...
    df_preds.to_csv(OUT_PREDS / "champion_predictions.csv", index=False)
    ...
    with open(OUT_METRICS / "champion_metrics.json", "w") as f:
