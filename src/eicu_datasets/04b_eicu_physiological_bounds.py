...
Phase 9: External Validation (eICU Physiological Bounds)
...
[FIX]: Adapted the mapping dictionary from MIMIC-IV's numeric itemids to 
       eICU's standardized string identifiers.
"""
