...
# MIMIC-IV Tensor Paths
MIMIC_TENSOR = BASE_DIR / "data" / "processed" / "mimiciv" / "tensors" / "sepsis_tensor_raw.npy"
MIMIC_FEATS = BASE_DIR / "data" / "processed" / "mimiciv" / "tensors" / "sepsis_tensor_features.npy"

# eICU Tensor Paths
EICU_TENSOR = BASE_DIR / "data" / "processed" / "eicu" / "tensors" / "eicu_sepsis_tensor_raw.npy"
...
def run_audit():
    ...
    if not MIMIC_TENSOR.exists() or not EICU_TENSOR.exists():
        print("[ERROR] Tensors not found. Ensure tensor builders have been run.")
        return
