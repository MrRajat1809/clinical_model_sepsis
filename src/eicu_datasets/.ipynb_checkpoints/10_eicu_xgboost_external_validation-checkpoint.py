...
Phase 9: External Validation (Locked XGBoost Inference)
...
- NO retraining on the eICU data.
...
- Applies the exact Mean/Min/Max/Std aggregation logic from Phase 4.
...
MODEL_DIR = BASE_DIR / "outputs" / "champion" / "models"
XGB_MODEL_FILE = MODEL_DIR / "champion_xgboost.joblib"

# Outputs
RESULTS_DIR = BASE_DIR / "results" / "eicu_external_validation"
METRICS_FILE = RESULTS_DIR / "eicu_champion_metrics.json"
ROC_PLOT_FILE = RESULTS_DIR / "eICU_Figure_4_Champion_ROC_PR.png"
PREDS_FILE = RESULTS_DIR / "eicu_champion_predictions.csv"
...
# ==========================================
def main():
    print("[*] Initiating Phase 9: External Validation (Champion XGBoost)...")
