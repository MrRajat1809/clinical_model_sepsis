...
def run_atlas_characterization():
    ...
    # Inputs
    dist_matrix_file = ATLAS_CLINICAL_DIR / "eicu_dtw_pairwise_distance_matrix.npy"
    ...
    # Outputs
    atlas_coords_file = ATLAS_CLINICAL_DIR / "eicu_phate_clinical_coordinates.parquet"
    plot_file = FIGURE_DIR / "eICU_Figure_3_Clinical_Trajectory_Manifold.png"
