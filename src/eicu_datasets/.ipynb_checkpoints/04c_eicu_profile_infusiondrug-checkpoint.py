...
Phase 9: External Validation (eICU Vasopressor Profiling)
...
[FIX]: Removed erroneous call to 'patientweight' from the cohort file. 
...
PROFILE_DIR = PROCESSED_DIR / "profiling"
...
def profile_infusion_drugs():
    ...
    out_json = PROFILE_DIR / "infusiondrug_profile.json"
    out_txt = PROFILE_DIR / "infusiondrug_profile_report.txt"
