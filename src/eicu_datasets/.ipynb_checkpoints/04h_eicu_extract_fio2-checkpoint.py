...
Phase 9: External Validation (eICU FiO2 Extraction)
...
[MEMORY SAFETY]: Enabled Polars streaming engine to prevent OOM crashes.
"""
...
def extract_fio2():
    ...
    # Calculate temporal window and cast to float
