...
Phase 12: External Recalibration (Pruned Model)
...
PREDS_FILE = BASE_DIR / "outputs" / "eicu_external_validation" / "eicu_pruned_predictions.csv"

# Outputs
OUT_PLOT = BASE_DIR / "outputs" / "eicu_external_validation" / "eicu_pruned_calibration_curve.png"
OUT_METRICS = BASE_DIR / "outputs" / "eicu_external_validation" / "eicu_pruned_calibration_metrics.json"
...
def main():
    print("[*] Initiating Strict External Recalibration (Pruned Model)...")
    
    if not PREDS_FILE.exists():
        print(f"[ERROR] Could not find pruned predictions at {PREDS_FILE}")
        return
    ...
    print("\n=========================================================================================")
    print(" RECALIBRATION IMPACT ANALYSIS (PRUNED MODEL - 20% eICU TEST SET)")
    print("=========================================================================================")
