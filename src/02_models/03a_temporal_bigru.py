...
def main():
    ...
    epochs_no_improve = 0
    history = []
    model_save_path = OUT_MODELS / "mimic_temporal_bigru_best.pth"
    ...
    np.save(OUT_FEATS / "mimic_temporal_bigru_embeddings.npy", X_embeddings)
    np.save(OUT_FEATS / "mimic_temporal_bigru_stay_ids.npy", stay_ids)
    ...
    df_preds.to_csv(OUT_PREDS / "mimic_temporal_bigru_predictions.csv", index=False)
